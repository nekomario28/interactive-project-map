...
const SCENE_WITH_BULGE = `${SCENE_ANCHOR}if(threeStyle==="galaxy")softenGalaxyCentralDust(dust);const galaxyBulge=threeStyle==="galaxy"?createGalaxyCentralBulge(THREE,username,glowTexture):null;if(galaxyBulge){scene.add(galaxyBulge);document.body.dataset.galaxyCentralStructure="bulge";}`;
