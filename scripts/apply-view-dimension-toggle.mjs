...
const THREE_D_STYLE = '<label class="field view-style-field"><span>Style</span><select id="threeStyle" aria-label="3D style"><option value="cosmic">Cosmic</option><option value="galaxy">Galaxy</option><option value="aurora">Aurora</option><option value="wireframe">Wireframe</option></select></label>';
