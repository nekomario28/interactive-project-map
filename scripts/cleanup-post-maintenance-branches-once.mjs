...
const targets = [
  "chore/dependabot-maintenance",
  "chore/update-pages-action-pin",
  "feat/view-controls-focus",
];
const self = "maintenance/post-maintenance-cleanup";
...
const headers = {
  ...
  "User-Agent": "interactive-project-map-post-maintenance-cleanup",
};
