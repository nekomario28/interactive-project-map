...
function clusterLayout(graph, width, height) {
  ...
  groups.forEach((group, index) => {
    ...
    const cx = groups.length === 1 ? centerX : centerX + Math.cos(angle) * orbitX;
