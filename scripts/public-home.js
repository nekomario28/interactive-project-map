...
function generate(){
  ...
  document.getElementById('staticUrls').value='SVG: '+u.svg+'\nGraph: '+u.graph+'\nInteractive: '+u.viewer;
  openMap.href=u.viewer;
  preview.classList.remove('ready');
  previewMessage.textContent='Checking for an existing generated SVG…';
  preview.src=u.svg;
  resultEl.classList.add('visible');
  statusEl.textContent='Setup generated. Add the workflow to '+v.username+'/'+v.username+' and run it once.';
