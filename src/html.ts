...
<body>
<div class="hud"><h1>${safeUsername} · Interactive Project Map</h1><p>Drag nodes · pan empty space · wheel or pinch to zoom · tap/click a project to open GitHub</p></div>
<a class="back" href="/">API docs</a>
<canvas id="galaxy" aria-label="Interactive project galaxy for ${safeUsername}"></canvas><div id="tip" class="tip"></div>
<script>
