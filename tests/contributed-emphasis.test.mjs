...
test("browser emphasis keeps Contributed in the Galaxy world but outside owned swept space", async () => {
  ...
  assert.match(source, /function externalHaloTargets\(external, sweepRadius\)/);
