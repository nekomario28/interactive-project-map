...
test("iPhone-sized WebKit keeps generator and route navigation usable", async ({ page }) => {
  ...
  await page.locator('[data-style-preset="tree"]').click();
  await expect(page.locator("#mapStyle")).toHaveValue("tree");
  ...
  await page.screenshot({ path: ".tmp/playwright-visual/webkit/galaxy.png", fullPage: true });
