...
test("mobile WebKit consumes the actual published Quality sidecar pair", async ({ page, request, browserName }) => {
  ...
  await page.locator("#galaxy").screenshot({ path: `${evidenceDir}/query-gated-quality-view-${browserName}.png` });
  await writeFile(
