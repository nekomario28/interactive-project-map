...
test("shared static Galaxy background preserves the historical profile-local structure without central arms", () => {
  ...
  assert.doesNotMatch(markup, /data-profile-galaxy-arm=/, "central curved Galaxy arms must stay absent");
