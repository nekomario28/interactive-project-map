...
const renderers={radial:(g)=>renderRadialTreeSvg(g,"dark",740,420),galaxy:(g)=>renderGalaxySvg(g,"dark",740,420,"galaxy"),obsidian:(g)=>renderGalaxySvg(g,"dark",740,420,"obsidian"),tree:(g)=>renderTreeSvg(g,"dark",740,420),timeline:(g)=>renderTimelineSvg(g,"dark",740,420)};
