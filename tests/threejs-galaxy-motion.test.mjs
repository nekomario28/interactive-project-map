...
test("Galaxy motion patch uses a flatter 2-4 arm disc, co-rotation, an inertial star backdrop, radial slowdown, and membership-only dynamic edges", () => {
  ...
  assert.match(patched, /model:"flat-curve-inspired",direction:"co-rotating",armCount:galaxyArmCount\(graph\),edgePolicy:"membership-only",starfieldFrame:"inertial"/);
